...
class Customers extends CI_Controller{
  ...
  function index()
  {
    ...
    $data  =
    array(
      'title'   =>  'Customers Management - Quick Corp',
  ...
  function add(){
    ...
    if ($valid->run()===false)
    {
      $data =
      array(
        'title'   =>  'Customers Management Add - Quick Corp',
  ...
  function update($user_id){
    ...
    if ($valid->run()===false)
    {
      ...
      $data =
      array(
        'title'   =>  'Customers Management Update - Quick Corp',
    ...
    else
    {
      ...
      $this->session->set_flashdata('success', '<center>Berhasil</center>');
      redirect('/manage/customers/update/'.$user_id);
    }
  }
