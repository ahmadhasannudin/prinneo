...
class Designers extends CI_Controller{
  ...
  function index()
  {
    ...
    $data  =
    array(
      'title'   =>  'Designers Management - Quick Corp',
  ...
  function add(){
    ...
    if ($valid->run()===false)
    {
      $data =
      array(
        'title'   =>  'Designers Management Add - Quick Corp',
  ...
  function update($user_id){
    ...
    if ($valid->run()===false)
    {
      ...
      $data =
      array(
        'title'   =>  'Designers Management Update - Quick Corp',
    ...
    else
    {
      ...
      $this->session->set_flashdata('success', '<center>Berhasil</center>');
      redirect('/manage/designers/update/'.$user_id);
    }
  }
