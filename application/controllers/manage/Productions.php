...
class Productions extends CI_Controller{
  ...
  function index()
  {
    ...
    $data  =
    array(
      'title'   =>  'Productions Management - Quick Corp',
  ...
  function add(){
    ...
    if ($valid->run()===false)
    {
      $data =
      array(
        'title'   =>  'Productions Management Add - Quick Corp',
  ...
  function update($user_id){
    ...
    if ($valid->run()===false)
    {
      ...
      $data =
      array(
        'title'   =>  'Productions Management Update - Quick Corp',
    ...
    else
    {
      ...
      $this->session->set_flashdata('success', '<center>Berhasil</center>');
      redirect('/manage/productions/update/'.$user_id);
    }
  }
