 ...
 <div id="main">
   <div class="container">
     <div class="row ">
       <div class="col-md-7">
         <form id="form-konfirmasi" onsubmit="return false;" action="<?php echo base_url() . 'cart/add_cart' ?>" method="POST" enctype='multipart/form-data'>
           ...
           <div class="form-group">
             ...
             <input type="text" name="nama_order" class="form-control" placeholder="Masukkan nama lengkap Anda" value="<?php echo $this->session->userdata('user_name') ?>">
           </div>
           <div class="form-row">
             ...
             <div class="form-group col-md-6">
               ...
               <input type="email" name="email_order" class="form-control" placeholder="Masukkan email Anda" value="<?php echo $this->session->userdata('email_user') ?>">
             </div>
           </div>
           <div class="form-row">
             <div class="form-group col-md-6">
           ...
           <div class="card">
             ...
             <div class="card-body">
               ...
               <div class="form-group">
                 ...
                 <textarea class="form-control" rows="3" placeholder="Masukkan pesan Anda" name="keterangan_order"></textarea>
               </div>
               <div class="row">
                 <div class="col-md-8">
                   <div class="form-group">
                     <div class="input-group input-group-sm mb-3">
                       ...
                       <div class="input-group-append">
                         <button class="btn btn-warning" type="button">Gunakan</button>
                       </div>
                     </div>
                   </div>
