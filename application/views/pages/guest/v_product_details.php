    ...
    <div id="main">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9">
            <form id="form-harga" action="<?php echo base_url() .  (($product_details->product_service == '0') ? 'cart/add' : 'cart/add_cart_product'); ?>" method="POST" enctype='multipart/form-data'>
                              ...
                              <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    ...
                                    <button type="submit" id="btn-add-to-cart" class="btn btn-success p-3" style="border:none;line-height: 1.2;width: 100%;padding: 0;text-align: left;">Add to Cart<i class="fas fa-chevron-circle-right float-right"></i></button>
                                  </div>
                                </div>
                              </div>
                            </div>
