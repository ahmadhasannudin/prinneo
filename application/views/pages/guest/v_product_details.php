    ...
    <div id="main">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9">
            <form id="form-konfirmasi" class="row" onsubmit="return false;" action="<?php echo base_url() . (($product_details->product_service == '0') ? 'cart/add' : 'cart/add_cart_product'); ?>" method="POST" enctype='multipart/form-data'>
              <input type="hidden" name="nama_order" class="form-control" value="<?= $this->session->userdata('user_name'); ?>" readonly>
              <input type="hidden" name="nohp_order" class="form-control" value="<?= $this->session->userdata('user_phone'); ?>" readonly>
              <input type="hidden" name="email_order" class="form-control" value="<?= $this->session->userdata('email_user'); ?>" readonly>
              <input type="hidden" name="jenis_order" value="beli" readonly>
              <input type="hidden" class="form-control" name="kode_order" value="<?php echo sprintf("%06d", mt_rand(1, 9999999999)); ?>" aria-label="Username" aria-describedby="basic-addon1" style="background-color: white" readonly>
                ...
                <div class="deskripsi-produk">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <!-- estimasi onkir -->
                      <h3 class="title-deskripsi">Estimasi Ongkos Kirim</h3>
                      <hr>
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                              <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingOne">
                                  ...
                                  <button type="submit" class="btn btn-success p-3" style="border:none;line-height: 1.2;width: 100%;padding: 0;text-align: left;">Add to Cart<i class="fas fa-chevron-circle-right float-right"></i></button>
                                </div>
                              </div>
                            </div>
                          </div>
