        ...
        <div class="row">
          ...
          <div class="row">
            <h4>
              ...
              <a href="<?php echo base_url().'blogs/categorys/'.$value->blog_category_slug ?>" class="link-kategori-main"><?php echo $value->blog_category_name ?></a> <br>
              <?php endforeach ?>
            </h4>
          </div>
        </div> 
                ...
                <div class="card" style="border-radius: 10px; border: 1px solid #b5b5b5;">
                  ...
                  <div class="card-body" style="height: 160px;">
                    <div class="float-none">
                      <a href="<?php echo base_url().'blogs/detail/'.$value->blog_slug ?>" class="judul-blog" style="font-size: 16px" title="<?php echo $value->blog_title ?>"><?php echo character_limiter($value->blog_title,50) ?></a>
                    </div>
                  ...
                  echo date_format($date,"d F Y"); ?></i>
                    ...
                    <div class="float-right">
                      <a href="<?php echo base_url().'blogs/detail/'.$value->blog_slug ?>" class="baca-blog">Selengkapnya</a>
                    </div>
                  </div>
                </div>
              </div>             
