<!-- banner -->
<div id="banner" style="background-image: url(<?php echo base_url().'assets/images/img_product_sub_categorys/'.$img_banner ?>);background-size: cover;">
  <div class="container">
...
<div id="main">
            ...
            <div class="card-body kategori">
              <div class="modal-body">
                <form action="<?php echo base_url().'login' ?>" method="post">
                  ...
                  <div class="form-group">
                    <span>Password</span>
                    <p class="float-right"><a href="<?php echo base_url().'lupa-password' ?>" style="color: red"> Lupa Password?</a></p>
          ...
          <div class="col-md-4 box-shadow">
            <div class="card " style="border-radius: 10px; border: 1px solid #b5b5b5;">
              ...
              <div class="card-body text-center" style="height: 160px;">
                <h5 class="title-best-seller"><a href="<?php echo base_url().'products/detail/'.strtolower($value->product_slug) ?>"><?php echo $value->product_name ?></a></h5>
                <p class="text-best-seller">Mulai dari Rp <?php echo $value->product_start_price ?></p>
                <a href="<?php echo base_url().'products/detail/'.strtolower($value->product_slug) ?>"><button type="button" class="btn btn-primary btn-best-seller">Detail</button></a>
              </div>
            </div>
          </div>
          <?php endforeach ?>
  ...
  <div class="container"><br>
    <div class="col-md-12">
      <h2 class="subtitle">Kategori Produk Lainnya</h2>
      <div class="row">   
        <div class="owl-carousel product-other owl-theme">

          <?php foreach ($product_categorys as $key => $value): 
            if ($value->product_category_id==$product_category_id) {
              # code...
            } else{
            ?>

          <div class="item box-shadow">
            <a href="<?php echo base_url().'products/category/'.strtolower($value->product_category_slug) ?>" class="card-link">
              <div class="card" style="border-radius: 10px; border: 1px solid #b5b5b5;">
                <img class="card-img-top" src="<?php echo base_url().'assets/images/img_product_categorys/'.$value->product_category_image ?>" alt="<?php echo $value->product_category_slug ?>" style="border-top-left-radius: 9px;  border-top-right-radius: 9px;">
                <div class="card-body text-center">
                  <h5 class="card-title"><?php echo $value->product_category_name ?></h5>
                </div>
              </div>
            </a>
          </div>
