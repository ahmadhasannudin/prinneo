  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-7 form-register">
        <h3>Lupa Password</h3>
        <p>Jangan khawatir tuliskan alamat email anda. Untuk mereset password</p>
        <form id="form-forgot-password" action="<?= base_url() . 'login/forgotEmail'; ?>" onsubmit="return false;" method="post">
