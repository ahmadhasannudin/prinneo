        ...
        <form id="form-konfirmasi" action="<?php echo base_url().'cart/add_cart' ?>" method="POST" enctype='multipart/form-data'>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="number" name="nohp_order" class="form-control" id="" placeholder="Masukkan no hp Anda">
            </div>
            <div class="form-group col-md-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-row">
                <div class="form-group col-md-6">
                 ...
                 <center>
                  <button type="button" class="btn btn-warning p-2"><i class="fa fa-file-upload mr-2"></i>Upload File</button>
                </center>
              </div>
              <div class="form-group col-md-6">
                <input type="file" name="file_order" class="dropify" data-height="150">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <input type="hidden" name="jenis_order" value="upload">
