      ...
      <div class="col-md-6 ">
        ...
        <div class="card">
          <div class="card-header">
            <h6>Tambah Product Sub-Kategori Baru</h6>
            </div>
            <div class="card-body">
              <?php
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="product_sub_category_name" value="" required>
              </div>
        ...
        <div class="col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-group">
                <label>Image :</label>
                <input type="file" class="form-control" placeholder="" name="product_sub_category_image" required>
