        ...
        <div class="row">
          ...
          <div class="col-md-4 d-none d-sm-block" id="about-footer">
            ...
            <ul style="list-style-type: none;margin: 0;padding: 0;font-size: 17px;">
              ...
              <li class="mb-3"><a><i class="fas fa-clock pr-2"></i><pre style="display: inline-flex;font-family: roboto;font-size: inherit;color: inherit;margin-bottom:inherit;"><?php echo $contacts->contact_time ?></pre></a></li>
              <li class="mb-3"><a><i class="fas fa-map pr-2"></i><pre style="display: inline-flex;font-family: roboto;font-size: inherit;color: inherit;margin-bottom:inherit;"><?php echo $contacts->contact_address ?></pre></a></li>
            </ul>
