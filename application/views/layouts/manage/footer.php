...
$(document).ready(function() {
  ...
  <?php if ($this->uri->segment(2) == 'products' && $this->uri->segment(3) == 'update' ) { ?>
    ...
    $.post("<?php echo base_url(); ?>manage/product_sub_categorys/get_product_sub_category_id_selected/"+product_sub_category_id+'/'+$('#product_category_id').val(),function(obj){$('#product_sub_category_id').html(obj);});
  <?php } ?>
} );
</script>
...
$('#product_category_id').click(function(){
  $.post("<?php echo base_url(); ?>manage/product_sub_categorys/get_product_sub_category_id/"+$('#product_category_id').val(),function(obj){$('#product_sub_category_id').html(obj);});
});
